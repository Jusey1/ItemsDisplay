...
public class DisplayTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> DISPLAYED = REGISTRY.register("display",
			() -> CreativeModeTab.builder().title(Component.translatable("item.items_displayed.item_group_name")).icon(() -> new ItemStack(DisplayItems.DISPLAY.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(Items.MUSIC_DISC_CREATOR);
				tabData.accept(Items.MUSIC_DISC_CREATOR_MUSIC_BOX);
				...
				tabData.accept(Items.MUSIC_DISC_PRECIPICE);
				...
				tabData.accept(Items.BOLT_ARMOR_TRIM_SMITHING_TEMPLATE);
				...
				tabData.accept(Items.FLOW_ARMOR_TRIM_SMITHING_TEMPLATE);
				...
				tabData.accept(Items.FLOW_POTTERY_SHERD);
				tabData.accept(Items.FRIEND_POTTERY_SHERD);
				tabData.accept(Items.GUSTER_POTTERY_SHERD);
				...
				tabData.accept(Items.SCRAPE_POTTERY_SHERD);
